...
const ChefDetails = () => {
    ...
    const { chef_name, chef_picture, likes,bio, years_of_experience, number_of_recipes, recipes } = chefData;
    console.log(recipes)
        ...
        <div>
            <div className="hero bg-indigo-400">
                <div className="hero-content flex-col lg:gap-96 lg:flex-row-reverse text-[#f3ebeb]">
                    <img src={chef_picture} className="lg:w-[450px] h-[500px] rounded-lg shadow-2xl" />
                    <div>
